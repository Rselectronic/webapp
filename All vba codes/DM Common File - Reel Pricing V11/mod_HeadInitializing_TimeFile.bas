Attribute VB_Name = "mod_HeadInitializing_TimeFile"
...
Public Set_Board_Name_tblHeading_Rng As Range
Public Set_Description_Under_Rng As Range
...
Public Set_QtyMatrics_Row As Long
Public Set_QtyMatrics_Data_Start_Row As Long
Public Set_QtyMatrics_Data_End_Row As Long
Public Set_QtyMatrics_Start_Col As Long
Public Set_QtyMatrics_End_Col As Long
 
 
Public Sub LoadGlobalRanges(wsSettings As Worksheet, wsFinal As Worksheet)
    ...
    For i = 2 To lastRow
        ...
        Select Case wsSettings.Cells(i, "A").value
            ...
            Case "Set_Board_Name_tblHeading_Rng":      Set Set_Board_Name_tblHeading_Rng = wsFinal.Range(addr)
            Case "Set_Description_Under_Rng":   Set Set_Description_Under_Rng = wsFinal.Range(addr)
