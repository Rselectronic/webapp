Attribute VB_Name = "Module4_V2"


Sub CopyAndRenameFile_PCB_Only()
    ...
    parentFolderName = ExtractFolderName_PCBOnly(fullPath)
    ...
    Set QuoteLogWS = jobQueueWB.Sheets("Quote Log")
...
'        cx6 = jobQueueSh.Cells(cxRow, "L")                                                  ' Contact Number
        ...
        If inputWS.Cells(i, DM_GlobalQTE_Column) = "" Then
            ...
            globalQuoteNumber = GetNextQuoteNumber_PCBOnly(lRow, inputWS, quoteabb)
            inputWS.Cells(i, DM_GlobalQTE_Column) = globalQuoteNumber
            
        End If
    
    Dim TIMEfile As String
    TIMEfile = Dir(timeProjectPath & "TIME V9 - PCB Only.xlsm")
...
'    Loop
    ...
    If Dir(parentPath & "6. BACKEND\TIME FILE\" & fileName & fileExtension) <> "" Then
        ...
        TimeWS.Range("C15:C18") = ""           ' standard labour
        TimeWS.Range("D15:D18") = ""           ' standard SMT
...
'        TimeWS.Range("G18") = CompCost4
        ...
        TimeWS.Range("K1") = Note1
                        ...
                        For currentRow = 4 To lastRow
                            If ws.Cells(currentRow, "K").value = "CP" Or ws.Cells(currentRow, "K").value = "CPEXP" Or ws.Cells(currentRow, "K").value = "0402" Or ws.Cells(currentRow, "K").value = "402" Then
                                countCP = countCP + 1
                            End If
                        Next currentRow
    ...
    Call BOM_export_PCBOnly(inputWS.Cells(i, DM_GlobalMFRPackage_Column), inputWS.Cells(i, DM_BomName_Column), prodPath & inputWS.Cells(i, DM_GlobalMFRPackage_Column), copiedWorkbook, summaryWS)
...
Function ExtractFolderName_PCBOnly(ByVal fullPath As String) As String
    ...
    ExtractFolderName_PCBOnly = folderName
End Function

Function GetNextQuoteNumber_PCBOnly(ByVal lRow As Long, inputWS As Worksheet, quoteabb As String) As String
    ...
    For j = 6 To lRow
        If inputWS.Cells(j, DM_GlobalQTE_Column) <> "" Then
            ...
            digits = CountDigits_PCBOnly(inputWS.Cells(j, DM_GlobalQTE_Column))
    ...
    If customDigits = 3 Then
        GetNextQuoteNumber_PCBOnly = quoteabb & Format(maxNumber + 1, "000")
    ElseIf customDigits = 4 Then
        GetNextQuoteNumber_PCBOnly = quoteabb & Format(maxNumber + 1, "0000")
...
Function CountDigits_PCBOnly(str As String) As Integer
    Dim i As Integer
    ...
    CountDigits_PCBOnly = digitCount
End Function

Function BOM_export_PCBOnly(SheetName As String, BOM_Name As String, savePath As String, copiedWorkbook As Workbook, summaryWS As Worksheet) As String
...
'    AddSummaryButtonToSheets_PCBOnly newSheet, copiedWorkbook
...
'Sub AddSummaryButtonToSheets_PCBOnly(pricingWS As Worksheet, copiedWorkbook As Workbook)
'    Dim ws As Worksheet
'    Dim btn As Object
